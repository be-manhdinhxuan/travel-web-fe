...
(function () {
  ...
  const NAV_HTML = `
<nav id="mainNav">
  <a href="1trangchu.html" style="display:flex;align-items:center;gap:9px;text-decoration:none">
  ...
  <ul class="nav-links">
    <li><a href="1trangchu.html">Điểm đến</a></li>
  ...
  <div class="nav-cta">
    ...
    <div id="navGuest" style="display:flex;gap:8px;align-items:center;">
      <button class="btn-login-nav" onclick="location.href='1dangnhap.html'">Đăng nhập</button>
