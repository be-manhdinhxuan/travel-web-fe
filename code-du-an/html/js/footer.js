...
<footer>
  <div class="footer-grid">
    <div class="footer-brand">
      <div class="footer-logo">
        ...
        <span class="footer-logo-text">Vietnam<span>Travel</span></span>
      </div>
      <p class="footer-desc">Trải nghiệm du lịch cao cấp tại Đông Nam Á. Chúng tôi cung cấp những dịch vụ lữ hành kết nối bạn với sắc phong phú, văn hóa đa dạng và cảnh quan tuyệt đẹp của miền Việt Nam.</p>
    ...
    <div class="footer-col">
      ...
      <ul>
        ...
        <li><a href="#">Chính sách bảo hộ</a></li>
    ...
    <div class="footer-newsletter">
      <h4>Bản tin</h4>
      <p>Đăng ký nhận ưu đãi và thông tin tốt từ đội ngũ chúng tôi mỗi tuần.</p>
  ...
  <div class="footer-bottom">
    <p>© 2026 VIETNAMTRAVEL. Bản quyền đã được bảo lưu.</p>
  ...
  window.renderSharedFooter = function renderSharedFooter(target) {
    const mountNode = resolveTarget(target);
    if (!mountNode) return false;
    mountNode.innerHTML = FOOTER_HTML;
    return true;
  };

  // Auto render when a page provides a placeholder.
  document.addEventListener('DOMContentLoaded', function () {
    const autoNode = document.querySelector('[data-shared-footer]');
    if (autoNode) window.renderSharedFooter(autoNode);
  });
})();
